...
const Project = ({title, subTitle, desc, features, dateStart, dateEnd, cta, img}) => {
            ...
            <div className="text">
                <Fade left>
                    <div className="container">
                        <p>
                            <span className="title text:amber-2">{title}</span><br/>
                            ...
                            <div className="desc text:grey-3">
                                ...
                                <ul className="features">
                                    {features.map((feature) => {
                                        return (
                                            <li>
                                                <i className="ti ti-shift-right sm:mr-2"></i> {t(feature)}
                                            </li>
                                        );
                                    })}
                                </ul>
                        ...
                        <br/>
                        <a href={cta} className="btn btn:rounded discover-button background:amber-2">
