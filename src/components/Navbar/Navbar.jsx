...
const Navbar = () => {
  ...
  function handleScroll(event, link, behavior) {
    ...
    document
      .querySelector(link)
      .scrollIntoView({ behavior: "smooth", block: behavior });
  }
    ...
    <div className="navbar background:grey-4 sticky-top">
      ...
      <div className="navbar-container">
        <div className="nav-link link-animated">
          <a
            className="hover:text:amber-2"
            onClick={(event) => handleScroll(event, "#about", "center")}
          >
            {t("Link-About")}
          </a>
        </div>
        <div className="nav-link link-animated">
          <a
            className="hover:text:amber-2"
            onClick={(event) => handleScroll(event, "#skills", "center")}
          >
            {t("Link-Skills")}
          </a>
        </div>
        <div className="nav-link link-animated">
          <a
            className="hover:text:amber-2"
            onClick={(event) => handleScroll(event, "#projects", "start")}
          >
            {t("Link-Projects")}
          </a>
        </div>
        <div className="nav-link link-animated">
          <a
            className="hover:text:amber-2"
            onClick={(event) => handleScroll(event, "#portfolio", "start")}
          >
            {t("Link-Portfolio")}
          </a>
        </div>
        <div className="nav-link link-animated">
          <a
            className="hover:text:amber-2"
            onClick={(event) => handleScroll(event, "#contact", "start")}
          >
            {t("Link-Contact")}
          </a>
        </div>
        <a
          href="https://www.github.com/HakkaOfDev"
          className="btn btn:rounded github-button background:amber-2"
        >
          <i className="ti ti-github"></i> Github
        </a>
