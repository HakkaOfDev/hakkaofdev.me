            ...
            <div className="container contact-container">
                ...
                <form>
                    <div className="form:group group:grey-3">
                        <input className="form:control" placeholder="default" name="pseudo"
                               onChange={() => handleChange(event)} required/>
                        <label htmlFor="pseudo" className="form:label" name="pseudo">Pseudo</label>
                    </div>
                    <div className="form:group group:grey-3">
                        <input className="form:control" placeholder="default" name="email"
                               onChange={() => handleChange(event)} required/>
                        <label htmlFor="email" className="form:label" name="email">Email</label>
                    </div>
                    <div className="form:group group:grey-3">
                        <label htmlFor="content" className="form:label">Message</label>
                        <textarea className="form:control" placeholder="default" name="content"
                                  onChange={() => handleChange(event)} required/>
                    </div>
                    <button role="input" className="btn btn:rounded background:amber-2"
                            onClick={() => handleSubmit(event)}>Envoyer
                    </button>
                    {success && (
                        <Fragment>
                            <hr/>
