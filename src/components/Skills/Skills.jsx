                    ...
                    <Slide left>
                        <div className="lg:col-12">
                            ...
                            <ul className="icons-dev">
                                ...
                                <li> {/* ts */}
                                    <svg viewBox="0 0 128 128">
                                        <path id="original-2" data-name="original" className="cls-2"
                                ...
                                <li> {/* redis */}
                                    <svg viewBox="0 0 128 128">
                                        ...
                                        <path fill="#D82C20"
                                              d="M106.9 53.3c-5 2.6-30.7 13.2-36.2 16-5.5 2.9-8.5 2.8-12.8.8-4.4-2.1-31.7-13.1-36.7-15.5-4.9-2.4-5-4-.2-5.9 4.8-1.9 32.1-12.6 37.8-14.6 5.8-2.1 7.8-2.1 12.6-.3 4.9 1.8 30.5 12 35.3 13.7 5 1.8 5.2 3.2.2 5.8z"></path>
                                        <path fill="#A41E11"
                                        ...
                                        <path fill="#D82C20"
                                              d="M106.9 22.1c-5 2.6-30.7 13.2-36.2 16-5.5 2.9-8.5 2.8-12.8.8-4.3-2.1-31.7-13.1-36.6-15.5s-5-4-.2-5.9c4.8-1.9 32.1-12.6 37.8-14.6 5.8-2.1 7.8-2.1 12.6-.3 4.9 1.8 30.5 12 35.3 13.7 4.9 1.7 5.1 3.2.1 5.8z"></path>
                                        <path fill="#fff"
                                              d="M76.2 13l-8.1.8-1.8 4.4-2.9-4.9-9.3-.8 6.9-2.5-2-3.8 6.5 2.5 6.1-2-1.7 4zM65.8 34.1l-15-6.3 21.6-3.3z"></path>
                                ...
                                <li> {/* next */}
                                    <img className="next-logo" src="/img/dev-icons/nextjs.svg" alt="nextjs"/>
                                </li>
                            </ul>
                        </div>
                    </Slide>
